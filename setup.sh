...
AGENT_CONFIG="/Users/henrycen/Developer/archive/agent-config"
...
mkdir -p "$HOME/.claude"
echo "@$AGENT_CONFIG/AGENTS.md" > "$HOME/.claude/CLAUDE.md"
ln -sf "$AGENT_CONFIG/skills" "$HOME/.claude/skills"
echo "✓ Claude Code"
...
ln -sf "$AGENT_CONFIG/skills" "$HOME/.codex/skills"
echo "✓ Codex"

# ── Gemini CLI ───────────────────────────────────────────
# Gemini reads ~/.gemini/GEMINI.md; supports @file imports
mkdir -p "$HOME/.gemini"
echo "@$AGENT_CONFIG/AGENTS.md" > "$HOME/.gemini/GEMINI.md"
echo "✓ Gemini CLI"
