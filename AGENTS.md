...
- Explain all user-facing responses to someone completely unfamiliar with the project. Keep responses to 1–3 sentences in one plain paragraph and address only the immediate request.
